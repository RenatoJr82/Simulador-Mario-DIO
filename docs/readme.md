...
## 1. Inicialização
- Criação dos objetos (personagens) do jogo
- Declaração das propriedades dos personagens (velocidade, manobrabilidade, poder)
- Função (main) para iniciar o jogo

## 2. Definição de Funções
- Criação das funções para rolar o dado e sortear o bloco
- Criação das funções para calcular os resultados dos confrontos (velocidade, manobrabilidade, poder)

## 3. Motor do Jogo
- Criação da função que cria a mecânica do jogo
